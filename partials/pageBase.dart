...
class PageBase {
  ...
  HtmlDoc toHtmlDoc() {
    return HtmlDoc(
        ...
        body: Body(
            widget_class:
                "bg-gray-100 dark:bg-gray-800 dark:text-white relative flex flex-col min-h-screen",
      ...
      document.documentElement.classList.add('dark')
              ...
              Div(
                  ...
                  widgets: [
                    Hyperlink(widgets: [
                      BrandLink(
                          widget_class: "hidden dark:block", brand: "sun"),
                      BrandLink(widget_class: "dark:hidden", brand: "moon")
                    ])
                  ]),
              Header(
                  widget_class:
                      "container flex justify-between md:justify-between gap-4 flex-wrap px-6 pt-3 mx-auto relative",
                  widgets: [
                    Hyperlink(
                        href: "/",
                    ...
                    Button(
                        widget_class:
                            "block relative h-auto mobile-menu-button md:hidden",
                        widgets: [
                          Div(
                              id: "line",
                              widget_class:
                                  "m-auto h-0.5 w-6 rounded dark:bg-gray-100 bg-gray-900 transition duration-300"),
                          Div(
                              id: "line2",
                              widget_class:
                                  "m-auto mt-2 h-0.5 w-6 rounded dark:bg-gray-100 bg-gray-900 transition duration-300"),
                          Div(
                              id: "line3",
                              widget_class:
                                  "m-auto mt-2 h-0.5 w-6 rounded dark:bg-gray-100 bg-gray-900 transition duration-300")
                    ...
                    UnorderedList(
                        widget_class:
                            "mobile-menu absolute z-100 h-0 md:h-auto overflow-hidden px-6 md:pb-6 md:p-0 top-full left-0 w-full md:w-auto md:relative md:flex md:flex-row flex-col items-center md:items-center gap-6 md:gap-6 bg-gray-100 dark:bg-gray-800 transition-all ease-in duration-300",
                        widgets: [
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold",
                              widgets: [
                          ...
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold",
                              widgets: [
                                Hyperlink(href: "/projects", text: "Projects")
                              ]),
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold",
                          ...
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold",
                              widgets: [
                                Hyperlink(href: "/contact", text: "Contact me")
                              ]),
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold hidden md:block",
                              widgets: [Span(text: "|")]),
                          ListItem(
                              widget_class:
                                  "grid place-items-center my-2 text-lg font-bold",
              ...
              Main(widget_class: "flex-1", widgets: listOfWidgets),
              Footer(
                  ...
                  widgets: [
                    Paragraph(
                        ...
                        text:
                            """© 2020-${DateTime.now().year} - Piotr Lange - Powered by ${Hyperlink(href: "https://github.com/PiotrZPL/dbml", text: "DBML", widget_class: "text-blue-500 font-bold").toHTML()}"""),
                  ]),
              Script(
                  script:
    ...
    //}
    """),
              Script(script: """function onWindowResize() {
